...
module Language.Nix.Identifier
  ( Identifier, ident, quote, needsQuoting, illegalSimpleIdentifiers
...
--   since it will accept 'illegalSimpleIdentifiers'.
...
--   identifiers by Nix, see 'illegalSimpleIdentifiers'.
...
needsQuoting s =
  s `elem` illegalSimpleIdentifiers
