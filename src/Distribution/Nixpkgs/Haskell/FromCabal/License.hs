      ...
      case simpl of
        SPDX.ELicenseId lid ->
          case lid of
            ...
            SPDX.AGPL_3_0_only -> Known "lib.licenses.agpl3"
            ...
            SPDX.GFDL_1_2_only -> Known "lib.licenses.fdl12"
            SPDX.GFDL_1_3_only -> Known "lib.licenses.fdl13"
            SPDX.GPL_1_0_only -> Known "lib.licenses.gpl1"
            SPDX.GPL_1_0_or_later -> Known "lib.licenses.gpl1Plus"
            SPDX.GPL_2_0_only -> Known "lib.licenses.gpl2"
            SPDX.GPL_2_0_or_later -> Known "lib.licenses.gpl2Plus"
            SPDX.GPL_3_0_only -> Known "lib.licenses.gpl3"
            ...
            SPDX.LGPL_2_0_only -> Known "lib.licenses.lgpl2"
            SPDX.LGPL_2_0_or_later -> Known "lib.licenses.lgpl2Plus"
            SPDX.LGPL_2_1_only -> Known "lib.licenses.lgpl21"
            SPDX.LGPL_2_1_or_later -> Known "lib.licenses.lgpl21Plus"
            SPDX.LGPL_3_0_only -> Known "lib.licenses.lgpl3"
